                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {item.label === "Présences" &&
                                                pendingNotices > 0 && (
                                                    <span
                                                        className="hidden lg:inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1.5 rounded-full bg-amber-500 text-white text-[11px] font-bold ml-auto"
                                                        title="Absences à valider dans le journal"
                                                    >
                                                        {pendingNotices}
                                                    </span>
                                                )}

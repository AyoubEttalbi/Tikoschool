...
import { Code, Palette, BookOpen, Calculator, Globe, Microscope, Music, Dumbbell, Trash2, LibraryBig } from "lucide-react";
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {subjectsData.map((subject) => (
            <SubjectCard key={subject.id} subject={subject} onDelete={setDeleteSubject} />
          ))}
        </div>
      </div>

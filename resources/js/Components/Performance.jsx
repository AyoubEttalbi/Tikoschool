...
const Performance = ({ student }) => {
    ...
    const calculateAttendanceScore = () => {
        ...
        console.log(
            "Valid attendance records for current academic year:",
            validAttendances,
        );
        ...
        if (validAttendances.length === 0) {
            console.log(
                "No attendance records found for current academic year, assuming all days present",
            );
            return 10;
        }

        // Count attendance types
        const absentDays = validAttendances.filter(
            (a) => a.status === "absent",
        ).length;
        const lateDays = validAttendances.filter(
            (a) => a.status === "late",
        ).length;
    ...
    const calculatePaymentScore = () => {
        ...
        console.log(
            "Valid memberships for current academic year:",
            validMemberships,
        );

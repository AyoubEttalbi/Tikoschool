...
const StudentForm = ({ type, data }) => {
  ...
  return (
    <form className="flex flex-col gap-8 p-6 bg-white shadow-lg rounded-lg" onSubmit={onSubmit}>
  ...
  <div className="flex justify-between flex-wrap gap-4">
    ...
    <div className="flex flex-col gap-2 w-full md:w-1/4">
      ...
      <select className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full" {...register("status")} defaultValue={data?.status}>
    ...
    <div className="flex flex-col gap-2 w-full md:w-1/4">
      ...
      <select className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full" {...register("assurance")} defaultValue={data?.assurance ? "true" : "false"}>

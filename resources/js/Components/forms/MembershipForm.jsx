...
const membershipSchema = z.object({
    teachers: z.record(
        z.object({
            teacherId: z
                .string()
                .min(1, { message: "Veuillez sélectionner un enseignant !" }),
        }),
    ),
});
        ...
        >
                ...
                >
                    ...
                    {offers.map((offer) => (
                        <option
                            key={offer.id}
                            value={offer.id}
                        >{`${offer.offer_name} - ${offer.price} DH`}</option>
                    ))}
                </select>
            </div>
            ...
            >
                ...
                {type !== "create" && (
                    ...
                    >
                        <Trash2 className="w-5 h-5" /> Supprimer l'adhésion
                    </button>
                )}
            </div>
        </form>
